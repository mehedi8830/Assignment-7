  ...
  return (
    <div>
      <div className="bg-gray-100 py-10 md:py-20">
        <div className="max-w-285 mx-auto px-5 grid grid-cols-1 lg:grid-cols-12 gap-4">
          ...
          <div className="lg:col-span-8 space-y-6">
            ...
            <div className="bg-white rounded-xl shadow py-8 px-6">
            ...
            <div className="bg-white rounded-xl shadow py-8 px-5">
              <h3 className="font-semibold text-xl text-success-content mb-4">
                Quick Check-In
              </h3>
